...
// applyRunOptions is a package-local thin wrapper around runtime.ApplyRunOptionsToConfig.
// Kept for test ergonomics in runoptions_test.go; production callers use the
// (*runtime.Runtime).ApplyRunOptions method directly.
