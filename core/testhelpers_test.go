...
func (mockTool) Definition() ToolDefinition {
...
func (mockToolCalc) Definition() ToolDefinition {
...
func (errTool) Definition() ToolDefinition {
...
func (readTool) Definition() ToolDefinition {
	return ToolDefinition{Name: "read", Description: "Read file"}
}
...
func (writeTool) Definition() ToolDefinition {
	return ToolDefinition{Name: "write", Description: "Write file"}
}
