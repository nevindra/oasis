...
- **VectorStore** -- Persistence layer with vector search over messages, document chunks, conversations, and scheduled actions. Ships with SQLite and libSQL (Turso) implementations.
