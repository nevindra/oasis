...
func buildToolNodeTemplateArgs(n NodeDefinition, tool core.AnyTool, toolName string, after []string, when func(*WorkflowContext) bool, baseOpts []StepOption) ([]WorkflowOption, error) {
...
// followed by the tool call step.
func buildToolNodeStaticArgs(n NodeDefinition, tool core.AnyTool, toolName string, after []string, baseOpts []StepOption) ([]WorkflowOption, error) {
